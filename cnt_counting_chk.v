task run_test();
    ...
    reg [63:0] final_count, cnt1;
    integer wait_cycles;
begin
    wait_cycles = 260; // Gán giá trị ở đây
    ...
    timer_reg_read(TDR0_OFFSET, read_val_lo);
    timer_reg_read(TDR1_OFFSET, read_val_hi);
    cnt1 = {read_val_hi, read_val_lo};
    check_value(cnt1, final_count, "Check counter value did not change");
